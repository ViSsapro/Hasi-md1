        ...
        try {
            ...
            if (isCmd) {
                ...
                if (command === 'ping') {
                    ...
                    await sock.sendMessage(from, { text: `🏓 *PONG!*\n\n⚡ Speed: ${speed}ms\n📡 Status: Online\n🤖 Bot: 𝐇ᴀꜱɪ 𝐌𝐃${earnFooterText}`, edit: msg.key });
                    return;
                }
                ...
                if (command === 'sticker' || command === 's') {
                    ...
                    if (isImage || isQuotedImage) {
                        ...
                        const sticker = new Sticker(buffer, { pack: '𝐇ᴀꜱɪ 𝐌𝐃 Pack', author: 'Vimukthi Thuhina', type: StickerTypes.FULL, quality: 70 });
...
if (command === 'ovp') {
    ...
    return;
                ...
                if (command === 'botinfo') {
                    ...
                    await sock.sendMessage(from, { text: `ℹ️ *𝐇ᴀꜱɪ 𝐌𝐃 Bot Info*\n\n👑 Owner: ᴄʜᴀᴍᴏᴅ x\n📦 Version: 1.0.0\n⏱️ Uptime: ${hours}h ${minutes}m\n📡 Status: Online${earnFooterText}` }, { quoted: mek });
                    return;
                }
